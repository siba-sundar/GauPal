            ...
            <form onSubmit={handleSubmit} className="space-y-4 overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <label className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${formData.userType === 'buyer' ? 'bg-green-50 border-green-500' : 'hover:bg-green-50'}`}>
                    <input
                      type="radio"
                      name="userType"
                      value="buyer"
                  ...
                  <label className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${formData.userType === 'farmer' ? 'bg-green-50 border-green-500' : 'hover:bg-green-50'}`}>
                    <input
                      type="radio"
                      name="userType"
                      value="farmer"
