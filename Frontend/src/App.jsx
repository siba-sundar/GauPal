...
import BreedDatabase from "./components/common/BreedDatabase.jsx";
...
import FLWGoogleMap from "./components/user/GoogleMapView.jsx";
...
const router = createBrowserRouter([
  {
    ...
    ), // Changed from ProtectedRoute to PublicRoute
  },
  {
    path: "/login",
    element: (
