...
const Navbar = () => {
  ...
  const productItems = [
    ...
    { icon: Clipboard, name: 'Cow Feed', path: '/products/cow-feed' },
    { icon: Clipboard, name: 'Cow Accessories', path: '/products/cow-accessories' },
    { icon: Truck, name: 'Organic Ghee', path: '/products/ghee' },
    { icon: Truck, name: 'Organic Milk Powder', path: '/products/milk-powder' },
    { icon: Truck, name: 'Farm Fresh Eggs', path: '/products/eggs' }
  ];
