...
const UserDashboard = () => {
  ...
  const [trendingProducts, setTrendingProducts] = useState([
    { id: 1, name: 'Organic A2 Milk', price: '₹80/liter', rating: 4.8, seller: 'Anand Organic Farm', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdiiPbXkftX8WeG9PZTpQONhAuAs6dFYPFRQ&s', category: 'Dairy' },
    { id: 2, name: 'Desi Ghee', price: '₹700/kg', rating: 4.9, seller: 'Kamdhenu Farms', image: 'https://kalyatatva.com/wp-content/uploads/2024/07/376-1.jpg', category: 'Dairy' },
    { id: 3, name: 'Cow Dung Cakes', price: '₹10/piece', rating: 4.5, seller: 'Gau Seva Kendra', image: 'https://www.shuddhamorganics.com/cdn/shop/products/7_1400x.jpg?v=1677954835', category: 'Fertilizer' },
    { id: 4, name: 'Panchagavya', price: '₹300/liter', rating: 4.7, seller: 'Vedic Farms', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQSvF-G6rkR5-m3HLNOWTQURNcJiV8HX3Ugfw&s', category: 'Ayurveda' },
  ]);
  ...
  // You can use these breed images in your featuredBreeds array or where needed
  const breedImages = {
    hariana: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT42VlAwyb8_q-1tlU2SzzEkHq1Ek8BBZ83qg&s',
    red_sindhi: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKL22gV8sTdr5nlKJnRIjH6qfdSY5k4DJuFA&s',
    ongole: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQcht3cMQFJNET95w-Ba6pEK4yGe8c-rfdlbg&s'
  };
